...
Analyzing year of bike sales data to identify which products, 
regions, and reps that drives revenue and profit — built as an Excel dashboard with KPI cards, 
...
but had no consolidated view of performance. 
Leadership wanted answers to three questions: 
Which product categories are worth doubling down on? 
Which regions and reps are outperforming? 
...
Electric eBikes punch way above their weight. They generated $462,000 — 42.7% of total revenue — from only 210 units sold (17% of total units). 
Compare that to City category bikes, which sold the most units (324) but brought in only $179,400. 
Fewer, higher-value sales beat volume here.
...
Eve Davis is the top-performing salesperson, generating $273,900 across 51 orders — about $42,500 more 
than the lowest performer despite a similar number of orders, suggesting a difference in what she's selling, not how much.
